...
<style>
  ...
  .publication-page .publication-tag {
    display: inline-flex;
    align-items: center;
  ...
  html:not([data-theme="dark"]) .publication-page h2,
  html:not([data-theme="dark"]) .publication-page h3,
  html:not([data-theme="dark"]) .publication-page .publication-title,
  html:not([data-theme="dark"]) .publication-page .publication-description,
  html:not([data-theme="dark"]) .publication-page .publication-tag {
    color: #333333;
  }

  html:not([data-theme="dark"]) .publication-page .publication-card {
    background: #fafafa;
    border-color: #dedede;
  }

  html:not([data-theme="dark"]) .publication-page .publication-meta {
    color: #4a4a4a;
  }
  ...
  <section class="publication-section">
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">procedural efficiency</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        <span class="publication-tag">healthcare</span>
        <span class="publication-tag">eye tracking</span>
        <span class="publication-tag">workload</span>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        <span class="publication-tag">digital health</span>
        <span class="publication-tag">machine learning</span>
        <span class="publication-tag">AI</span>
        <span class="publication-tag">human factors</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">safety</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        <span class="publication-tag">healthcare</span>
        <span class="publication-tag">wearable sensing</span>
        <span class="publication-tag">physiological data</span>
        <span class="publication-tag">stress</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">stress</span>
        <span class="publication-tag">workflow</span>
        <span class="publication-tag">technology use</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        <span class="publication-tag">healthcare</span>
        <span class="publication-tag">digital health</span>
        <span class="publication-tag">telecritical care</span>
        <span class="publication-tag">COVID-19</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">decision-making</span>
        <span class="publication-tag">workflow</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">simulation</span>
        <span class="publication-tag">human performance</span>
      </div>
    </article>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        ...
        <span class="publication-tag">eye tracking</span>
        <span class="publication-tag">UX</span>
    ...
    <article class="publication-card">
      ...
      <div class="publication-tags">
        <span class="publication-tag">digital systems</span>
        <span class="publication-tag">decision analysis</span>
        <span class="publication-tag">service quality</span>
        <span class="publication-tag">usability</span>
      </div>
    </article>
